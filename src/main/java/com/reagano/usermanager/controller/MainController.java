package com.reagano.usermanager.controller;
...
import com.reagano.usermanager.service.UserProfileService;
import com.reagano.usermanager.service.UserService;
...
public class MainController {
	...
	/**
	 * This method will handles existing user-dashboard.
	 */
	...
	/**
	 * This method will handles admin-dashboard
	 */
	...
	/**
	 * This method will provide the medium to update an existing user account.
	 */
	@RequestMapping(value = { "/account/update" }, method = RequestMethod.GET)
	public String editUserAcc(ModelMap model) {
