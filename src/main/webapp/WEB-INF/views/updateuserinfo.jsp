...
<head>
  ...
  -->
  <link rel="stylesheet" href="<c:url value='/resources/css/skins/skin-red.min.css'/>"/>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="index2.html" class="logo">
      ...
      <span class="logo-mini"><b>N</b>DT</span>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Update your user info</a></li>
    ...
    <section class="content">
           ...
           <div class="panel panel-default">
						<div class="panel-heading">Edit/modify user account info</div>						
			...
			<div class="box-body">    
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<c:choose>
							<c:when test="#">
								<input type="text" path="ssoId" id="ssoId" class="form-control input-sm" disabled="true"/>
							</c:when>
							<c:otherwise>
								<input type="text" path="ssoId" id="ssoId" class="form-control input-sm" />
								<div class="has-error">
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" path="telephone" id="telephone" class="form-control input-sm" />
					</div>
				</div>	
				...
				<div class="box-footer">
					<c:choose>
						<c:when test="${edit}">
							<input type="submit" value="Update" class="btn btn-info"/> or <a href="<c:url value='/dashboard' />">Cancel</a>
						</c:when>
						<c:otherwise>
							<input type="submit" value="Register" class="btn btn-primary btn-sm"/> or <a href="<c:url value='/dashboard' />">Cancel</a>
						</c:otherwise>
					</c:choose>
				</div>			
		      </form>
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2016 <a href="#">NeuDATA</a>.</strong> All rights reserved. |  NEU Cloud Computing Lab.
  </footer>
