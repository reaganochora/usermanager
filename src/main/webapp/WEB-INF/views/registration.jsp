  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li><a href="<c:url value='/admin-dashboard' />"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a></li>
        <li class="active"><a href="<c:url value='/user-accounts' />"><i class="fa fa-users"></i> <span>Manage Users</span></a></li>
		<li><a href="<c:url value='/data-mgt' />"><i class="fa fa-database"></i> <span>Manage Data</span></a></li>
		<li><a href="<c:url value='/data-price' />"><i class="fa fa-money"></i> <span>Manage Prices</span></a></li>
